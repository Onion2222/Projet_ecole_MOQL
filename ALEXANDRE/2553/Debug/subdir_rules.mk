...
board.obj: ../board.c $(GEN_OPTS) | $(GEN_HDRS)
	@echo 'Building file: "$<"'
	@echo 'Invoking: MSP430 Compiler'
	"D:/ti/ccsv8/tools/compiler/ti-cgt-msp430_18.1.2.LTS/bin/cl430" -vmsp --use_hw_mpy=none --include_path="D:/ti/ccsv8/ccs_base/msp430/include" --include_path="C:/Users/alexandre.sannier/Documents/Fontanet/2eme_annee/OBJETS COMMUNICANTS/PROJET MOQL  - BUS DE COM/PROJET/Projet_ecole_MOQL/ALEXANDRE/2553" --include_path="D:/ti/ccsv8/tools/compiler/ti-cgt-msp430_18.1.2.LTS/include" --advice:power=all --define=__MSP430G2553__ -g --printf_support=minimal --diag_warning=225 --diag_wrap=off --display_error_number --preproc_with_compile --preproc_dependency="board.d_raw" $(GEN_OPTS__FLAG) "$<"
	@echo 'Finished building: "$<"'
	@echo ' '
