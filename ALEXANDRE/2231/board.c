...
BOOL up = FALSE;                                /* sens de variation du servo */
UINT_32 cmd = 0;                                /* periode du signal de commande moteur */


UINT_32  result_adc =0 ;
UINT_32  distance = 0;
    ...
    if( !up )                                     /* Si sens décroissant*/
             {
                  ...
                  else
                  {
                      ...
                      up = TRUE;                     /* Changer le sens du moteur */
                  }
             }
             ...
             else                                 /* Si sens croissant */
             {
                 ...
                 else
                 {
                     ...
                     up = FALSE;                   /* Changer le sens du moteur */
                 }
              }
              TACCR1 = cmd;
}
